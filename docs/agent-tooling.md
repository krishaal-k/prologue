...
### `vercel`
- Source: `https://mcp.vercel.com` (official Vercel hosted remote MCP, HTTP transport)
- OAuth (read-only by default). Search Vercel docs, list projects / deployments, pull build + runtime logs. First use prompts authentication.
